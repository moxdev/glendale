<?php
/**
 * The Glendale functions and definitions
 *
...
function glendale_setup() {
	 ...
	 * If you're building a theme based on The Glendale, use a find and replace
...
function glendale_scripts() {
	...
	wp_enqueue_script( 'glendale-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
